...
public:
    ...
    // IDrawable interface
    virtual bool init(QSharedPointer<ShaderProgram> program) override;
    virtual void draw(QSharedPointer<ShaderProgram> program, QSharedPointer<Camera> camera) override;
